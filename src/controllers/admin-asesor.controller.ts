...
export class AdminAsesorController {
  ...
  async find(
    ...
    return this.adminRepository.gestionaAsesores(id).find(filter);
  }
  ...
  async create(
    ...
    return this.adminRepository.gestionaAsesores(id).create(asesor);
  }
  ...
  async patch(
    ...
    return this.adminRepository.gestionaAsesores(id).patch(asesor, where);
  }
  ...
  async delete(
    ...
    return this.adminRepository.gestionaAsesores(id).delete(where);
  }
}
